...
export function HomePage() {
  ...
  return (
    <>
      ...
      {/* Selección del catálogo — la pared de galería es lo primero que se ve después del titular */}
      <section aria-labelledby="seleccion-title" className="container-x pb-24 md:pb-32">
        <Reveal className="flex flex-wrap items-end justify-between gap-6 border-t border-ink pt-6">
          <div>
            ...
            <h2 id="seleccion-title" className="text-h2 mt-3">Colgados ahora</h2>
          </div>
        ...
        <div className="mt-12 lg:mt-16">
          {loading ? (
            <p className="label" role="status">Cargando obras…</p>
          ) : (
